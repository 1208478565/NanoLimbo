...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "a2033824-2ce0-4df9-9c72-173447622ac1"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "rus.dfmg.de5.net");        // argo固定隧道隧道域名
        ...
        envVars.put("TUIC_PORT", "26825");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("REALITY_PORT", "26825");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
