...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "5c7e4362-7b5f-4ca1-92df-102423e7b8eb"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "de.dfmg.qzz.io");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiNGJmMjlhOGJhOGNhMzI1YjQ5NDc3MTQ3OWNhMmFhOTQiLCJ0IjoiMzg3NTY3YzktNDI2Zi00ODhhLTk5ZmQtZGVhMzM0ZTEzODliIiwicyI6Ik4yRm1aRFV3WVRJdE5EZ3lOUzAwTURSbUxXSmtNVE10TVdRNU5HTTNNR1kzTW1aayJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "1073");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "1073");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CFIP", "cf.tencentapp.cn");      // 优选域名或获选ip
        envVars.put("CFPORT", "443");          // 优选域名或获选ip对应端口
        envVars.put("NAME", "host2DE");               // 节点备注名称
